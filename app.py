...
def inicio_page():
    ...
    if not st.session_state['authenticated']:
        ...
        st.markdown(f"<p>¡Bienvenido {user_role}!</p>", unsafe_allow_html=True)
...
def solicitar_datos_page():
    ...
    elif st.session_state['user_role'] == "BanCoppel":
        opciones_disponibles = ['BanCoppel']
    elif st.session_state['user_role'] == "Monte de Piedad":
...
def main():
    ...
    if 'aws_session' not in st.session_state:
        try:
            st.session_state['aws_session'] = create_aws_session()
